...
- Switched devpkg-nginx to the nginxinc/nginx-unprivileged base image and re-applied cap_drop: [ALL] / no-new-privileges, adding back only CAP_CHOWN so it can take ownership of its tmpfs-backed cache directory
### Added
### Fixed
