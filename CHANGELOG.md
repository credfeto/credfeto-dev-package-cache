...
- Hardened containers in docker-compose.yml by dropping all Linux capabilities and setting no-new-privileges, adding back only the capabilities nginx genuinely needs
### Added
### Fixed
